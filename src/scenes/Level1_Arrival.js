...
export default class Level1_Arrival extends Phaser.Scene {
   ...
   preload() {
    ...
    create() {
        ...
        this.nightOverlay.fillStyle(0x000000, 0.5);
    ...
    createAnimatedTrees(w, h) {
        ...
        for (let i = 0; i < topTreeCount; i++) {
            const x = i * topSpacing + Math.random() * 200 - 50;
            const y = h * 0.12 + Math.random() * 60;
        ...
        for (let i = 0; i < bottomTreeCount; i++) {
            const x = i * bottomSpacing + Math.random() * 250 - 100;
            const y = h * 0.82 + Math.random() * 40;
            const treeType = Math.random() > 0.5 ? 'tree_1_sway' : 'tree_2_sway';
    ...
    createFlora(w, h) {
        ...
        for (let i = 0; i < bushCount; i++) {
            ...
            const yVariation = Math.random() > 0.5 ? h * 0.20 : h * 0.78;
        ...
        for (let i = 0; i < flowerCount; i++) {
            ...
            flower.setScale(0.18 + Math.random() * 0.15);
            flower.setDepth(21);
